...
const Accounts = (props) => {
    ...
    useEffect(() => {
        console.log('account', loading, setLoading)
        instance.post('/accounts/', { userId: user })
            .then((res) => {
                ...
                <div className="fixed inset-0 z-50">
                    <div className="min-h-screen pt-4 px-4 pb-20 text-center block p-0">
                        ...
                        <div className="inline-block bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all my-8 align-middle max-w-lg w-full">
                            {
                                isEditForm ?
                                    (<EditAccountForm data={data} id={id} userId={user} handleMessage={handleMessage} handleModalCancel={handleModalCancel} handleDeleteMessageClicked={handleDeleteMessageClicked} setLoading={setLoading} />)
                                    : (<CreateAccountForm userId={user} handleMessage={handleMessage} handleModalCancel={handleModalCancel} setLoading={setLoading} />)
                            }
